import 'package:dollar_app/features/main/polls/provider/vote_provider.dart';
...
class _VotePopupWidgetState extends ConsumerState<VotePopupWidget> {
  ...
  Widget build(BuildContext context) {
     ...
     final isVoted = votedVideos.contains(widget.postId);
            ...
            child: Column(
              ...
              children: [
                !isErrored
                    ? Text(
                        isVoted
                            ? 'This action will remove your vote'
                            : 'This action proceed to  vote',
                  ...
                  children: [
                    ...
                    AppPrimaryButton(
                     ...
                     title: isVoted ? 'unvote' : 'vote',
                      putIcon: false,
                      enabled: true,
                     color: isVoted ? Colors.red : Colors.green,
                    )
                  ],
                )
              ],
