...
class DeletePopupWidget extends ConsumerStatefulWidget {
  const DeletePopupWidget({super.key, this.onPress, required this.postId});
  final String postId;
  final VoidCallback? onPress;

  @override
  ConsumerState<DeletePopupWidget> createState() => _DeletePopupWidgetState();
}

class _DeletePopupWidgetState extends ConsumerState<DeletePopupWidget> {
