...
class PublishPopupWidget extends ConsumerStatefulWidget {
  const PublishPopupWidget({super.key, this.onPress, required this.postId});
  final String postId;
  final VoidCallback? onPress;

  @override
  ConsumerState<PublishPopupWidget> createState() => _PublishPopupWidgetState();
}

class _PublishPopupWidgetState extends ConsumerState<PublishPopupWidget> {
                    ...
                    AppPrimaryButton(
                      onPressed: () {
                        final future = ref
                            ...
                            .publishVideo(context, postId: widget.postId);
